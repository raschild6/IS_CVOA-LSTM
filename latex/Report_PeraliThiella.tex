...
\title{Predizioni attraverso GA e LSTM basate sul Covid-19}
%Your title must be in mixed case, not sentence case. 
% That means all verbs (including short verbs like be, is, using,and go), 
% nouns, adverbs, adjectives should be capitalized, including both words in hyphenated terms, while
% articles, conjunctions, and prepositions are lower case unless they
% directly follow a colon or long dash
\author{Università degli studi di Padova\\ Corso di Sistemi Intelligenti\\Anno 2019-20 \\ % All authors must be in the same font size and format. Use \Large and \textbf to achieve this result when breaking a line
...
\begin{abstract}
In questi ultimi anni il Machine Learning (ML) sta riscuotendo una visibilità e un successo senza precendenti nella storia dell'intelligenza artificiale, questo sicuramente grazie anche alla vasta gamma di problemi in cui può essere applicato: dal riconoscimento tramite immagini, analisi del parlato, previsioni su sequenze di dati, etc. \\
Nella fase di training degli algoritmi di ML è richiesto al progettista di trovare dei buoni iperparametri in grado di ottenere nella fase di test i migliori risultati, tuttavia questa fase può richiedere diverso tempo in quanto dipende fortemente dal tipo di problema che si sta affrontando e dal dataset utilizzato, non rendendo possibile la condivisione di parametri preimpostati. \\
In questo corso abbiamo voluto approfondire un metodo meta-euristico basato sulla genetica evolutiva \cite{martnezlvarez2020coronavirus}, che prende spunto dalla diffusione di un virus nella popolazione, utilizzandolo per il calcolo automatico degli iperparametri per la fase di allenamento di un algoritmo di ML.
\end{abstract}
